...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<li id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<div class="photos">
			...
			<?if(
				!empty($arItem["DISPLAY_PROPERTIES"]["MAP_X"]["VALUE"]) &&
				!empty($arItem["DISPLAY_PROPERTIES"]["MAP_Y"]["VALUE"]) &&
				!empty($arItem["DISPLAY_PROPERTIES"]["MAP_ZOOM"]["VALUE"])
			){?>
				<div class="imap" data-coord-x="<?=$arItem["DISPLAY_PROPERTIES"]["MAP_X"]["VALUE"]
					?>" data-coord-y="<?=$arItem["DISPLAY_PROPERTIES"]["MAP_Y"]["VALUE"]
					?>" data-zoom="<?=$arItem["DISPLAY_PROPERTIES"]["MAP_ZOOM"]["VALUE"]
					?>"></div>
			<?}?>
			</div>
		</div>
